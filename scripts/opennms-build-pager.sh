...
echo 'opennms-plugins-pagerduty wait-for-kar=opennms-pagerduty-plugin' | sudo tee ~/opennms/target/opennms-31.0.0-SNAPSHOT/etc/featuresBoot.d/pagerduty.boot
